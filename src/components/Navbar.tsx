...
export default function Navbar() {
  ...
  const DropDownMenuItemClasses: string = " duration-300 hover:bg-neutral-200/50 rounded-sm p-1"
  return (
    <header className="min-h-16 p-5">
      <nav className="border z-50 rounded-lg bg-white/80 p-3 flex justify-between items-center">
        <Link href="/" className="font-semibold text-neutral-700">DineSphere</Link>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="mr-3 rounded p-2 bg-white border text-sm space-y-1">
              ...
              <SignedIn>
                ...
                <DropdownMenuItem className={DropDownMenuItemClasses}>
                  <Link href="/restaurants" className="text-neutral-700 text-sm item">Restaurants</Link>
                </DropdownMenuItem>
                <DropdownMenuItem className={DropDownMenuItemClasses}>
                  Settings
                </DropdownMenuItem>
              ...
              <SignedOut>
                ...
                <DropdownMenuItem className={DropDownMenuItemClasses}>
                  <Link href="/sign-in" className="text-neutral-700 text-sm">Sign In</Link>                </DropdownMenuItem>
                <DropdownMenuItem className={DropDownMenuItemClasses}>
                  <Link href="/sign-up" className="text-neutral-700 text-sm">Sign Up</Link>                </DropdownMenuItem>
              </SignedOut>
            </DropdownMenuContent>
          </DropdownMenu>
